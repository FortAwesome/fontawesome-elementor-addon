...
class Settings_Page {
	...
	<div class="fontawesome-elementor-addon-kit-setup">
		...
		<svg style="color: red;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
		...
		<?= esc_html__( "Failed!", 'fontawesome-elementor-addon' ) ?>
		</span>
		<span id="fontawesome-elementor-addon-kit-setup-status-success" style="margin-left:8px; display: none;">
		<svg style="color: green;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
		...
		<?= esc_html__( "Kit is setup and you’re ready to add icons!", 'fontawesome-elementor-addon' ) ?>
		</span>
		</div>
